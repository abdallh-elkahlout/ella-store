<template>
  <div class="nav-bar">
    <v-app-bar color="#02218f" height="fit-content" absolute class="pt-5 pr-2">
      <v-container fluid>
        <v-row>
          <v-col cols="3">
            <router-link :to="{ name: 'home' }">
              <img style="cursor: pointer" src="@/assets/logo.png" alt="" />
            </router-link>
          </v-col>
          <v-col cols="5">
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <div
                ...
                :style="`width: 28px; fill: #ffb547;cursor:pointer; pointer-events: ${
