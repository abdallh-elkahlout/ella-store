        ...
        <v-col v-for="card in cards" :key="card.title" class="px-2">
          <v-hover v-slot="{ isHovering, props }">
            <v-card
              ...
              v-bind="props"
              class="rounded text-center d-flex align-center justify-center"
              height="400"
              elevation="2"
  ...
  data: () => ({
    cards: [
      ...
      },
      {
        ...
        description: "37 overseas werehouses",
      ...
      {
        title: "FAST SHIPPING",
        description: "Fast and converient door to door delivery",
      ...
      },
      {
        ...
        description: "More than 10 diffrent secure payment methods",
      ...
      },
      {
        ...
        description: "24/7 Customer Service Were here and happy to help!",
