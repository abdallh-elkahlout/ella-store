    ...
    <v-container fluid class="ma-0 pa-0">
      <v-row>
        <v-col cols="7">
          ...
          >
            <v-card-title style="font-weight: 700" class="py-0">
              new-ella-demo
            </v-card-title>
            <v-breadcrumbs
              :items="['Cart', 'Informations']"
            ...
            <v-divider class="mt-3" length="100%" color="black"></v-divider>
            <v-divider length="100%" color="black"></v-divider>
            <v-card-text style="font-size: 11px; color: #484848"
...
export default {
  data: () => ({
    countries: ["palestine", "japan", "iraq"],
    dialog: false,
  }),
  computed: {
